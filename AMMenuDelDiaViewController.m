...
#import "AMParser.h"
#import "AMMenuTable.h"
#import "AMPedido5.h"
#import "MBProgressHUD.h"
#import "AMQRPedidoViewController.h"
#import "AMRegistro.h"
#import "SWRevealViewController.h"
#import "AMResumenViewController.h"
#import <Parse/Parse.h>
#import "AMPedidoNaviViewController.h"

@interface AMMenuDelDiaViewController ()<MFMailComposeViewControllerDelegate,UIAlertViewDelegate,NSXMLParserDelegate,MBProgressHUDDelegate>
...
@implementation AMMenuDelDiaViewController
    ...
    if (!self.festivo) {
        ...
        if (([self.menu.primeros count] + [self.menu.segundos count]) == 0) {
            ...
            if (hour > 13) {
                ...
                [self performSegueWithIdentifier:@"pedido5" sender:self];
            }
        }
    }
    else {
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if([segue.identifier isEqualToString:@"segueQR"]) {
        AMPedidoNaviViewController *navi = segue.destinationViewController;
        navi.papi = self;
        AMQRPedidoViewController *qrVC = (AMQRPedidoViewController *) navi.viewControllers[0];
        qrVC.menus = self.menus;
    }
    if([segue.identifier isEqualToString:@"pedido5"]) {
        AMPedidoNaviViewController *navi = segue.destinationViewController;
        navi.papi = self;
        AMPedido5 *alarma = (AMPedido5 *) navi.viewControllers[0];
