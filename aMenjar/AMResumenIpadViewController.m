...
@interface AMResumenIpadViewController ()<MBProgressHUDDelegate,UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,UITextFieldDelegate,PTKViewDelegate>
...
@implementation AMResumenIpadViewController
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    UIView *view = [[UIView alloc] initWithFrame:(CGRectMake(0.0f, 0.0f, 508.0f, 105.0f))];
    ...
    UILabel *take = [[UILabel alloc] initWithFrame:(CGRectMake(387.0f, 8.0f, 113.0f, 29.0f))];
    ...
    UILabel *cubiertos = [[UILabel alloc] initWithFrame:(CGRectMake(284.0f, 38.0f, 216.0f, 28.0f))];
    ...
    UILabel *precioL = [[UILabel alloc] initWithFrame:CGRectMake(393.0f, 62.0f, 54.0f, 34.0f)];
    precioL.text = @"Precio:";
    ...
    UILabel *precio = [[UILabel alloc] initWithFrame:CGRectMake(446.0f, 62.0f, 54.0f, 34.0f)];
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    if ((section + 1) == [self.menus count]) {
        ...
        UIView *view = [[UIView alloc] initWithFrame:(CGRectMake(0.0f, 0.0f, 508.0f, 215.0f))];
        
        UIImageView *fotoQR = [[UIImageView alloc] initWithFrame:CGRectMake(179.0f, 50.0f, 150.0f, 150.0f)];
        fotoQR.image = self.QR;
        [view addSubview:fotoQR];
        
        UILabel *precioL = [[UILabel alloc] initWithFrame:CGRectMake(388.0f, 8.0f, 54.0f, 34.0f)];
        precioL.text = @"Total:";
        [precioL setTextAlignment:NSTextAlignmentRight];
        precioL.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:15.0f];
        precioL.textColor = [UIColor whiteColor];
        ...
        UILabel *precio = [[UILabel alloc] initWithFrame:CGRectMake(441.0f, 8.0f, 59.0f, 34.0f)];
        ...
        UILabel *guardar = [[UILabel alloc] initWithFrame:(CGRectMake(179.0f, 172.0f, 150.0f, 28.0f))];
    ...
    UIView *view = [[UIView alloc] initWithFrame:(CGRectMake(0.0f, 0.0f, 508.0f, 10.0f))];
    return view;
}
...
-(IBAction)rotate:(id)sender
{
    ...
    [UIView animateWithDuration:0.25
                     ...
                     completion:^(BOOL finished){
                         [self.tablaResumen performSelectorOnMainThread:@selector(removeFromSuperview) withObject:nil waitUntilDone:NO];
...
-(void)addStripeView
{
    ...
    self.vistaPagos = [[UIView alloc] initWithFrame:CGRectMake(541, 59, 508, 541)];
    self.vistaPagos.layer.cornerRadius = 25.0f;
    [self.vistaPagos setBackgroundColor:[UIColor blackColor]];
    
    UILabel *precio = [[UILabel alloc] initWithFrame:CGRectMake(430, 110.0f, 70, 35)];
    ...
    UILabel *precioL = [[UILabel alloc] initWithFrame:CGRectMake(325, 110.0f, 100, 35)];
    precioL.textColor = [UIColor whiteColor];
    ...
    UILabel *seguro = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, ((541/2.0f)+33.0f), 478, 52)];
    ...
    UILabel *recoger = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, 155, 478, 60)];
    ...
    UILabel *payandgo = [[UILabel alloc] initWithFrame:CGRectMake(8, 25, 492, 70)];
    payandgo.textColor = [UIColor colorWithRed:(51.0f/255.0f) green:(51.0f/255.0f) blue:(51.0f/255.0f) alpha:1.0f];
    payandgo.text = @"PAY & GO";
    payandgo.font = [UIFont fontWithName:@"HelveticaNeue-Medium" size:70.0f];
    [self.vistaPagos addSubview:payandgo];
    
    UIImageView *stripeImage = [[UIImageView alloc] initWithFrame:CGRectMake(415, ((541/2.0f)+75.0f), 85.0f, 40.0f)];
    stripeImage.image = [UIImage imageNamed: @"stripeLogo"];
    [self.vistaPagos addSubview:stripeImage];
    
    PTKView *view = [[PTKView alloc] initWithFrame:CGRectMake(8,((541/2.0f)-23.0f),492,46)];
...
- (void)createToken:(STPCheckoutTokenBlock)block
{
    ...
    [Stripe createTokenWithCard:scard
                 publishableKey:@"pk_live_XSI6LLUoH0Tkt8mF4l0kqjhk"
...
{
    [self.HUD hide:YES];
    self.confirm = [[UIView alloc] initWithFrame:CGRectMake(541, 59, 508, 541)];
    ...
    UIView *forma = [[UIView alloc] initWithFrame:CGRectMake(179.0f, ((541/2.0f)-75), 150.0f, 150.0f)];
    ...
    UIImageView *check = [[UIImageView alloc] initWithFrame:CGRectMake(192.0f, ((541/2.0f)-62.5f), 125.0f, 125.0f)];
    check.image = [UIImage imageNamed:@"finalCheck"];
    [self.confirm addSubview:check];
    UILabel *hecho = [[UILabel alloc] initWithFrame:CGRectMake(220.0f, (((541/2.0f)-62.5f)+146), 68.0f, 21.0f)];
    hecho.text = @"Hecho";
    ...
    [UIView animateWithDuration:0.25
                     animations:^{
                         ...
                         [self.confirm setFrame:CGRectMake(16.0f, 59.0f, 508.0f, 541)];
                     }
                     completion:^(BOOL finished){
