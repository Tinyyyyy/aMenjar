...
@interface AMMapViewController ()<MKMapViewDelegate,MBProgressHUDDelegate,CLLocationManagerDelegate>

@property (weak, nonatomic) IBOutlet MKMapView *map;
@property(nonatomic, retain) CLLocationManager *locationManager;
@property NSArray *rutas;
...
- (IBAction)calcularRuta:(id)sender
{
    ...
    if (self.enrutado) {
        ...
        self.HUD.labelText = @"Calculando ruta";
...
- (IBAction)showRouteDetails:(id)sender {
    [self performSegueWithIdentifier:@"rutasSegue" sender:self];
}

- (IBAction)unwindToNothing:(UIStoryboardSegue *)segue{ }

-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    AMRoutesViewController *routeVC = segue.destinationViewController;
    routeVC.rutas = self.rutas;
}
